...
var score,randomFruit, position;

var gameOverSound, KnifeSwipe;

var fruitGroup,monsterGroup;
var fruit, fruit1, fruit2 ,fruit3,fruit4;
var knife, monster, knifeImage,  monsterImage; 
var gameOverImage;
...
function preload(){
  ...
  knifeSwipe = loadSound("knifeSwoosh.mp3");
}
...
function Monster(){
  if(World.frameCount%200===0){
    monster=createSprite(610,200,20,20);
